...
const projectId="2S8et9x8Em4DfArVE0dRSrxd42i"
const projectSecret="1e88f9dddd4f1952980aeb96702c06ec"
...
export default function CreateItem(){
  ...
  async function onChange(e){
    ...
    try{
      ...
      const url=`https://hitesh-nftmarket.infura-ipfs.io/ipfs/${added.path}`
      setFileUrl(url)
    }catch(error){
